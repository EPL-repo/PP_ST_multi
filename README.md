...
Companion code of Adimi et al 2025 **"Spatial multi-omics for biomarker discovery in Head and Neck cancer using a single tissue section"**, for the analysis of the generated spatial transcriptomics and proteomics data. Preprint can be found [here](https://www.biorxiv.org/content/10.1101/2024.10.03.616510v1).
...
```
- R snippet to calculate Immunogenicity Index on Visium samples
---
